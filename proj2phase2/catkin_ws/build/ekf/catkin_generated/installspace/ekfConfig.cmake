...
if("FALSE" STREQUAL "TRUE")
  set(ekf_SOURCE_PREFIX /home/gary9555/Desktop/ELEC6910P/proj2phase2/catkin_ws/src/ekf)
  set(ekf_DEVEL_PREFIX /home/gary9555/Desktop/ELEC6910P/proj2phase2/catkin_ws/devel)
  set(ekf_INSTALL_PREFIX "")
  set(ekf_PREFIX ${ekf_DEVEL_PREFIX})
else()
  set(ekf_SOURCE_PREFIX "")
  set(ekf_DEVEL_PREFIX "")
  set(ekf_INSTALL_PREFIX /home/gary9555/Desktop/ELEC6910P/proj2phase2/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'ekf' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'kunyue <ksu@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'ekf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gary9555/Desktop/ELEC6910P/proj2phase2/catkin_ws/install/${idir}'.  Ask the maintainer 'kunyue <ksu@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${ekf_dep}_FOUND)
      find_package(${ekf_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${ekf_dep} REQUIRED ${depend_list})
  endif()
